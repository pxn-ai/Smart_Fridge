...
CAMERA_EXPOSURE_TIME = 15000  # microseconds — hint only when AE is enabled
CAMERA_ANALOGUE_GAIN = 2.0
CAMERA_FRAME_DURATION_MIN = 15000
CAMERA_FRAME_DURATION_MAX = 33333

# OCR guide overlay / crop settings
OCR_GUIDE_BOX_WIDTH_RATIO = 0.92
OCR_GUIDE_BOX_HEIGHT_RATIO = 0.85
OCR_GUIDE_BOX_CENTER_X = 0.50
OCR_GUIDE_BOX_CENTER_Y = 0.48
